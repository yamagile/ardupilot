      ...
      elseif (stage == 3 ) then   -- Stage3: fly a vertical circle
        ...
        if (sub_stage == 0) then
          if (sub_count > 20) then
            ...
            sub_count = 0
          elseif (sub_count % 2 == 0) then
            circle_angle = 90
          else
            circle_angle = 0
          end
        elseif (sub_stage == 1 or sub_stage == 3) then
          if (sub_count > 9) then
            sub_stage = sub_stage + 1
            sub_count = 0
          elseif (sub_count % 2 == 0) then
        ...
        elseif (sub_stage == 2 or sub_stage == 4) then
          if (sub_count > 9) then
            sub_stage = sub_stage + 1
            sub_count = 0
          elseif (sub_count % 2 == 0) then
        ...
        gcs:send_text(0, "stage 3: " .. tostring(circle_angle) .. " " .. tostring(count) .. " " .. tostring(sub_count) .. " " .. tostring(sub_stage))
